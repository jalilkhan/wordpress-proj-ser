...
if ( isset($field) ) {
    if ( isset($field['type']) && isset($field['text']) ) {
        ...
        ?>
        <label for="bt_bb_listing_field_price_range_from" class="bt_bb_price_range_from_label"><?php esc_html_e( 'Price range', 'bt_plugin' ); ?> 
            <span class="bt_bb_listing_note">(<?php echo BoldThemesFrameworkTemplate::$currency_symbol;?>)</span>
        </label>
        <div class="bt_bb_control_container">
			<div class="bt_bb_control_half">
				<input name="bt_bb_listing_field_price_range_from" id="bt_bb_listing_field_price_range_from" type="number" value="<?php echo $value1;?>"  min="0" max="1000" step="5" placeholder="<?php echo __( 'Price From', 'bt_plugin' );?>">
			</div>
			<div class="bt_bb_control_half">
