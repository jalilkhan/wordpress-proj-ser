...
class SingleResult implements ResultInterface {
	 ...
	 * @since 2.3
	 */
	public function __construct( $value, $display_message = null, $code = null, $is_warning = false ) {
...
class_alias( \OTGS\Toolset\Common\Result\SingleResult::class, '\Toolset_Result' );
