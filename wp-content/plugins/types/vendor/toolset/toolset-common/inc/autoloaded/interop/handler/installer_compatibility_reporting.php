...
class InstallerCompatibilityReporting implements HandlerInterface {
	...
	private function get_privacy_policy_url( $context ) {
		return 'https://toolset.com/privacy-policy-and-gdpr-compliance/?utm_source=plugin&utm_campaign=toolset&utm_medium=gui&utm_term=privacy-policy-and-gdpr-compliance';
	}
