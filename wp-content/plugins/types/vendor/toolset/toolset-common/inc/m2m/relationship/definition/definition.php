...
class Toolset_Relationship_Definition implements IToolset_Relationship_Definition {
	...
	public function create_association( $parent, $child, $intermediary_id = null ) {
		...
		return $this->get_database_layer_factory()->association_database_operations()->create_association( $this, $parent, $child, $intermediary_id, true );
	}
	...
	public function get_max_associations( $role ) {
		...
		return $this->get_database_layer_factory()->association_database_operations()->count_max_associations( $this->get_row_id(), $role_name );
	}
