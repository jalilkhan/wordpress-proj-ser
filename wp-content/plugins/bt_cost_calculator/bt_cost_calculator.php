...
function bt_quote_map_sc() {
	...
	$bt_quote_params = array(
		...
		array( 'param_name' => 'time_format', 'type' => 'dropdown', 'default' => '24', 'heading' => __( 'Time Input Format', 'bt-cost-calculator' ), 'group' => __( 'Contact-Form', 'bt-cost-calculator' ),
			'value' => array(
				__( '24-hour clock', 'bt-cost-calculator' ) 			=> '24',
				__( '12-hour (AM/PM) clock', 'bt-cost-calculator' ) 	=> '12'
		) ),	
