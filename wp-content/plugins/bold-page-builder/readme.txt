...
>
> You can easily import all our demo pages and start building website in no time. Read the instructions [here](https://wordpress.org/plugins/bold-page-builder/installation/).
>
...
Bold builder should work with most of the themes - free or premium. In fact, all demos are developed using free themes and plugins from WordPress.org. You can import these pages and choose from a selection of carefully crafted design elements.
