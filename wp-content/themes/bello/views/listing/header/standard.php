...
if ( $title != '' ) {
	...
	<section class="bt_bb_section gutter bt_bb_vertical_align_top btPageHeadline btListingHeadline">
		<div class="bt_bb_grayscale_image <?php echo esc_attr( $extra_class );?>" style="background-image:url(<?php echo esc_url_raw( $feat_image );?>);" data-parallax="<?php echo esc_attr( $parallax );?>" data-parallax-offset="-400"></div>
